...
insert into public.learning_units (
  ...
  ('lu10', 'vpshr-level-0', 'vpshr-level-0-core', 'lu10', 'unit10', 'Investigations', 'Handle security investigations with fairness and care.', '15 min', 10, '/courses/vpshr-level-0/LU10 Investigations/11. Investigations-Final (Published)', '/courses/vpshr-level-0/LU10 Investigations/11. Investigations-Final (Published)/index.html'),
  ('lu11', 'vpshr-level-0', 'vpshr-level-0-core', 'lu11', 'unit11', 'Civil Unrest', 'Prepare for protest and unrest scenarios with restraint.', '15 min', 11, '/courses/vpshr-level-0/LU11 Civil-unrest', '/courses/vpshr-level-0/LU11 Civil-unrest/index.html'),
  ('lu12', 'vpshr-level-0', 'vpshr-level-0-core', 'lu12', 'unit12', 'Surveillance and Monitoring', 'Balance security monitoring with privacy and accountability.', '12 min', 12, '/courses/vpshr-level-0/LU12 Surveillance/LU 11 Surveillance and monitoring-final (Published)', '/courses/vpshr-level-0/LU12 Surveillance/LU 11 Surveillance and monitoring-final (Published)/index.html')
on conflict (id) do update set
  slug = excluded.slug,
