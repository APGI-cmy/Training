...
export function ScannexAssessmentWorkspace({
  ...
  return <div className="admin-workspace-grid">
    <section className="admin-form-card">
      ...
      <p className="form-guidance">Only enrolled learners can be scheduled. The generated reference must be used in the Scannex Trainer result and Viewer Movement Log file names.</p>
    ...
    <section className="admin-form-card">
      ...
      <p className="form-guidance">Record the local file names or approved evidence references. Do not enter Scannex passwords or personal identity numbers.</p>
      <form className="form-stack" action={evidenceAction}>
        ...
        <label>Decision<select name="decision" defaultValue="evidence_pending"><option value="evidence_pending">Evidence recorded — awaiting decision</option><option value="passed">Passed</option><option value="failed">Not yet competent</option></select></label>
