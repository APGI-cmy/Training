...
const template = [
  "email,first_name,last_name,company,country,operation_subdivision,department_team,course_slug,access_basis,reason,expires_at",
  "learner@example.com,Ada,Lovelace,Example Company,South Africa,,,scannex-training-programme,corporate_order,Corporate training allocation,2026-12-31T23:59"
].join("\n");
