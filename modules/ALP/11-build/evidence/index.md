...
| Status | Updated for PR #98 merged W4.2 code/build posture; controlled live proof pending |
| Date | 2026-07-23 |
...
| W4.2 | `modules/ALP/11-build/evidence/20260723-W4-GOV-ALP-098-decision-w4-2-build-to-green.md` | QA-ALP-252-267 | Catalogue/admin invitation/access management build | TypeScript / Vitest / Next.js / Vercel | PR #98 / `85431882b9f8824c5b1f544649e6305bf700d60d` | Exact-head typecheck, 16/16 W4.2 tests, W1/W4.1 regressions, build and Vercel passed | Product owner / reviewer | Code/build implementation merged; live proof pending | Migration `010` merged but not applied; no live role, invitation or enrolment write performed. |
| W4.2 Batch 3 Lane A | `modules/ALP/11-build/evidence/20260728-W4-GOV-ALP-102-decision-batch3-correct-red.md` | QA-ALP-B3-001..020 | Controlled RED for portal/course-flow stabilisation | TypeScript / Vitest / GitHub Actions | PR #102 / `3d9cc74f83c64e46a9134977e57fec5115691e54` | Exact-head correct RED PASS; run `30342160476` | Foreman QA/governance correction | PBFAG PASS; Stage 10 blocked | No product implementation or builder appointment. |
| W4.2 Batch 3 Lane A | `modules/ALP/10-builder-appointment/addenda/20260728-batch3-lane-a-builder-appointment.md` | QA-ALP-B3-001..020 | Stage 11 bounded appointment | GitHub / governance evidence | PR #102 / `APPT-ALP-B3-LA-001` | Stage 11 PASS | Foreman / CS2 proxy | Build-to-Green authorised for frozen Lane A only | Merge, invitation delivery, payments, cleanup and production-readiness claims remain excluded. |
| W4.2 Batch 3 Lane A | `modules/ALP/11-build/evidence/20260728-W4-ALP-102-batch3-build-to-green.md` | QA-ALP-B3-001..020 | Portal/course-flow code and build | TypeScript / Vitest / Next.js | PR #102 / `15422413d1ccf7d36c9069ca24e07fa22604516c` | Local and CI GREEN | BC-ALP-B3-LA-001 | Code/build GREEN | Browser proof and audit disposition remain blockers. |
| W4.2 Batch 3 Lane A | `modules/ALP/11-build/evidence/20260728-W4-ALP-102-batch3-exact-head-deployment-proof.md` | TASK-B3-LA-203 | Exact-head deployment | GitHub Actions / Vercel | PR #102 / `15422413d1ccf7d36c9069ca24e07fa22604516c` | GitHub SUCCESS; Vercel READY | Foreman | Partial | Vercel preview protected by SSO. |
| W4.2 Batch 3 Lane A | `modules/ALP/11-build/evidence/20260728-W4-ALP-102-batch3-final-iaa.md` | TASK-B3-LA-205 | Final IAA | Assurance review | PR #102 / `15422413d1ccf7d36c9069ca24e07fa22604516c` | NO-GO | Independent IAA | ASSURANCE-TOKEN NOT ISSUED | Browser proof and dependency-audit blockers must resolve before merge. |
| W4.2 Batch 3 Lane A | `modules/ALP/11-build/evidence/20260805-W4-ALP-102-rebase-release-candidate.md` | TASK-B3-LA-203..205 | Rebase / dependency remediation | Git / Vitest / TypeScript / Next.js / npm audit | PR #102 / rebased candidate | Local GREEN; audit 0 high/critical | Release-gate reconciliation | Exact-head CI and preview smoke pending | Successor evidence; it does not supersede the final IAA until the exact-head checks complete. |
...
W4.2: CODE/BUILD IMPLEMENTATION MERGED AND AUTOMATED GREEN ACCEPTED; LIVE DB/BROWSER PROOF PENDING.  
