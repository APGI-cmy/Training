...
| W4.2 | `modules/ALP/11-build/evidence/20260723-W4-GOV-ALP-098-decision-w4-2-build-to-green.md` | QA-ALP-252-267 | Catalogue/admin invitation/access management build | TypeScript / Vitest / Next.js / Vercel | PR #98 / `85431882b9f8824c5b1f544649e6305bf700d60d` | Exact-head typecheck, 16/16 W4.2 tests, W1/W4.1 regressions, build and Vercel passed | Product owner / proxy reviewer | Code/build implementation merged; live proof pending | Migration `010` merged but not applied; no live role, invitation or enrolment write performed. |
